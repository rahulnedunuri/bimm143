...
Here we check if the sum across each row is larger than 0 and only keep
those rows.
...
![](lab14_files/figure-commonmark/unnamed-chunk-10-1.png)
...
```
    ...
    Info: Working in directory /Users/rahulnedunuri/Documents/ucsd courses/senior classes/winter 24/bimm 143/bimm143_github/class14
...
Cell cycle has the most significant entities p-value. This matches the
earlier KEGG result. Reactome has more specificity of genes and might
have more possible results for the pathways involved.
